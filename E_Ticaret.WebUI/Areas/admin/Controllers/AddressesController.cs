...
namespace E_Ticaret.WebUI.Areas.admin.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,City,District,Street,OpenAddress,IsActive,IsBillingAddress,IsDeliveryAddress,CreateDate,AddressGuid,AppUserId")] Address address)
        {
