...
namespace E_Ticaret.Data.Migrations
{
    ...
    [Migration("20250129093154_OrderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 1, 29, 12, 31, 53, 469, DateTimeKind.Local).AddTicks(4017),
                            ...
                            UserGuid = new Guid("b729d110-a8d8-4495-ae01-4f12f8b4891e"),
                            UserName = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 1, 29, 12, 31, 53, 473, DateTimeKind.Local).AddTicks(4209),
                            Image = "1.jpg",
                            IsActive = true,
                            IsTopMenu = true,
                            Name = "Elektronik",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 1, 29, 12, 31, 53, 473, DateTimeKind.Local).AddTicks(5232),
                            Image = "2.jpg",
                            IsActive = true,
                            IsTopMenu = true,
                            Name = "Bilgisayar",
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.OrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Ticaret.Core.Entities.Address", b =>
                {
                    b.HasOne("E_Ticaret.Core.Entities.AppUser", "AppUser")
                        .WithMany("Addresses")
